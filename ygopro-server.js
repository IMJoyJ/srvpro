...
// support web given format
  ...
  CLIENT_import_data = global.CLIENT_import_data = function(client, old_client, room) {
    var index, key, len5, len6, p, player, q, ref4;
    ref4 = room.players;
    for (index = p = 0, len5 = ref4.length; p < len5; index = ++p) {
      player = ref4[index];
    ...
    for (q = 0, len6 = import_datas.length; q < len6; q++) {
      key = import_datas[q];
  ...
  CLIENT_is_player = global.CLIENT_is_player = function(client, room) {
    var is_player, len5, p, player, ref4;
    is_player = false;
    ref4 = room.players;
    for (p = 0, len5 = ref4.length; p < len5; p++) {
      player = ref4[p];
  ...
  CLIENT_get_kick_reconnect_target = global.CLIENT_get_kick_reconnect_target = function(client, deckbuf) {
    var len5, len6, p, player, q, ref4, room;
  ...
  CLIENT_send_pre_reconnect_info = global.CLIENT_send_pre_reconnect_info = function(client, room, old_client) {
    var len5, p, player, ref4, req_pos;
  ...
  getSeedTimet = global.getSeedTimet = function(count) {
    var curTime, i, offset, p, ref4, ret;
    ret = [];
    for (i = p = 0, ref4 = count; (0 <= ref4 ? p < ref4 : p > ref4); i = 0 <= ref4 ? ++p : --p) {
      curTime = null;
  ...
  Room = class Room {
    constructor(name, hostinfo) {
      var death_time, draw_count, duel_log_id, duel_rule, i, lflist, p, param, q, rule, seeds, start_hand, start_lp, time_limit;
    ...
    delete() {
      var end_time, formatted_replays, index, len5, log_rep_id, name, p, player_ips, player_names, recorder_buffer, ref4, ref5, repbuf, replay_id, room_name, score, score_array, score_form;
      if (this.deleted) {
        return;
      }
    ...
    send_replays() {
      var len5, len6, p, player, q, ref4, ref5;
    ...
    disconnect(client, error) {
      var index, left_name, len5, len6, p, player, q, ref4, ref5;
      if (client.had_new_reconnection) {
        return;
      }
    ...
    finish_recover(fail) {
      var buffer, len5, p, player, ref4, results;
      if (fail) {
  ...
  net.createServer(function(client) {
    ...
    client.on('data', async function(ctos_buffer) {
      var bad_ip_count, buffer, ctos_filter, handle_data, len5, len6, len7, p, q, r, ref4, ref5, ref6, room;
      if (client.is_post_watcher) {
        room = ROOM_all[client.rid];
        if (room) {
    ...
    server.on('data', async function(stoc_buffer) {
      var buffer, handle_data, len5, p, ref4;
  ...
  ygopro.ctos_follow('JOIN_GAME', true, async function(buffer, info, client, server, datas) {
    var available_logs, check_buffer_indentity, create_room_with_action, len5, len6, len7, len8, line, name, p, pre_room, q, r, recover_match, ref4, ref5, ref6, ref7, replay_id, room, s, struct;
    //log.info info
    ...
    if (CLIENT_is_able_to_reconnect(client) || CLIENT_is_able_to_kick_reconnect(client)) {
      ...
      if (settings.modules.cloud_replay.engine === 'mysql') {
        ...
        mysqldb.query(sql, function(err, replay) {
          var i, p, ref4, results;
          if (err || !replay) {
            return;
          }
          results = [];
          for (i = p = 0, ref4 = replay.length; (0 <= ref4 ? p < ref4 : p > ref4); i = 0 <= ref4 ? ++p : --p) {
      ...
      create_room_with_action = function(buffer, decrypted_buffer, match_permit) {
        var action, len5, len6, len7, len8, line, name, opt1, opt2, opt3, options, p, player, q, r, ref4, ref5, ref6, ref7, room, room_title, s, title;
        if (client.closed) {
          return;
        }
      ...
      if (pre_room && pre_room.duel_stage !== ygopro.constants.DUEL_STAGE.BEGIN && settings.modules.cloud_replay.enable_halfway_watch && !pre_room.hostinfo.no_watch) {
        ...
        _async.auto({
          ...
          var create_room_name, found, len6, len7, len8, len9, line, match, player, q, r, ref10, ref5, ref6, ref7, ref8, ref9, s, t, user;
          if (client.closed) {
            return;
          }
  ...
  ygopro.stoc_follow('JOIN_GAME', false, async function(buffer, info, client, server, datas) {
    var len5, len6, len7, line, p, player, q, r, recorder, ref4, ref5, ref6, room, watcher;
    //欢迎信息
    room = ROOM_all[client.rid];
  ...
  ygopro.stoc_follow('GAME_MSG', true, async function(buffer, info, client, server, datas) {
    var act_pos, chain, check, count, cpos, deck_found, found, hint_type, i, i1, id, j1, len10, len11, len12, len13, len5, len6, len7, len8, len9, limbo_found, line, loc, max_loop, msg, oppo_pos, p, phase, player, playertype, pos, ppos, q, r, r_player, reason, ref10, ref11, ref12, ref13, ref14, ref4, ref5, ref6, ref7, ref8, ref9, room, s, t, trigger_location, val, win_pos, x, y, z;
    room = ROOM_all[client.rid];
    if (!(room && !client.reconnecting)) {
      return;
    }
    ...
    if (settings.modules.heartbeat_detection.enabled && ygopro.constants.MSG[msg] === 'CONFIRM_CARDS') {
      ...
      for (i = s = 3, ref9 = max_loop; s <= ref9; i = s += 7) {
    ...
    if (settings.modules.heartbeat_detection.enabled && client.pos === 0) {
      if (ygopro.constants.MSG[msg] === 'CHAINING') {
        ...
        found = false;
        for (t = 0, len8 = long_resolve_cards.length; t < len8; t++) {
          id = long_resolve_cards[t];
          if (!(id === card)) {
            continue;
          }
          found = true;
      ...
      if (ygopro.constants.MSG[msg] === 'SUMMONING' || ygopro.constants.MSG[msg] === 'SPSUMMONING' || ygopro.constants.MSG[msg] === 'CHAINING') {
        ...
        if (ygopro.constants.MSG[msg] !== 'CHAINING' || (trigger_location & 0x8) && client.ready_trap) {
          if (settings.modules.vip.enabled && room.dueling_players[act_pos].vip && vip_info.players[room.dueling_players[act_pos].name].dialogues[card]) {
            ...
            for (j1 = 0, len13 = ref14.length; j1 < len13; j1++) {
              line = ref14[j1];
              ygopro.stoc_send_chat(client, line, ygopro.constants.COLORS.PINK);
            }
          }
  ...
  ygopro.stoc_follow('HS_PLAYER_CHANGE', true, async function(buffer, info, client, server, datas) {
    var is_ready, len5, len6, p, p1, p2, player, pos, q, ref4, ref5, room;
    room = ROOM_all[client.rid];
  ...
  ygopro.stoc_follow('DUEL_END', false, async function(buffer, info, client, server, datas) {
    var len5, len6, p, player, q, ref4, ref5, room;
    room = ROOM_all[client.rid];
  ...
  wait_room_start_arena = async function(room) {
    var display_name, len5, p, player, ref4;
  ...
  ygopro.stoc_follow('DUEL_START', false, async function(buffer, info, client, server, datas) {
    var deck_arena, deck_name, deck_text, len5, len6, p, player, q, ref4, ref5, room;
    room = ROOM_all[client.rid];
    if (!(room && !client.reconnecting)) {
      return;
    }
  ...
  ygopro.ctos_follow('UPDATE_DECK', true, async function(buffer, info, client, server, datas) {
    var current_deck, deck, deck_array, deck_main, deck_side, deck_text, deckbuf, decks, found_deck, i, len5, len6, line, oppo_pos, p, q, recover_player_data, room, struct, win_pos;
    ...
    buff_main = (function() {
      var p, ref4, results;
      results = [];
      for (i = p = 0, ref4 = info.mainc; (0 <= ref4 ? p < ref4 : p > ref4); i = 0 <= ref4 ? ++p : --p) {
        results.push(info.deckbuf[i]);
      }
      return results;
    })();
    buff_side = (function() {
      var p, ref4, ref5, results;
      results = [];
      for (i = p = ref4 = info.mainc, ref5 = info.mainc + info.sidec; (ref4 <= ref5 ? p < ref5 : p > ref5); i = ref4 <= ref5 ? ++p : --p) {
        results.push(info.deckbuf[i]);
      }
      return results;
    })();
    ...
    if (room.duel_stage === ygopro.constants.DUEL_STAGE.BEGIN && room.recovering) {
      ...
      for (p = 0, len5 = decks.length; p < len5; p++) {
        deck = decks[p];
      ...
      if (found_deck) {
        ...
        for (q = 0, len6 = deck_array.length; q < len6; q++) {
          line = deck_array[q];
  ...
  ygopro.stoc_follow('CHAT', true, async function(buffer, info, client, server, datas) {
    var len5, p, pid, player, ref4, room, tcolor, tplayer;
    room = ROOM_all[client.rid];
    pid = info.player;
  ...
  ygopro.stoc_follow('REPLAY', true, async function(buffer, info, client, server, datas) {
    var duellog, dueltime, i, len5, len6, p, player, q, ref4, ref5, replay_filename, room;
    room = ROOM_all[client.rid];
    if (!room) {
    ...
    if (settings.modules.tournament_mode.enabled && settings.modules.tournament_mode.replay_safe || settings.modules.tournament_mode.enable_recover) {
      if (client.pos === 0) {
        ...
        if (room.hostinfo.mode !== 2) {
          ...
          for (i = q = 0, len6 = ref5.length; q < len6; i = ++q) {
            player = ref5[i];
      ...
      if (settings.modules.cloud_replay.enabled && settings.modules.tournament_mode.enabled && settings.modules.tournament_mode.replay_safe) {
        if (room.sent_cloud_replay === void 0) {
  ...
  if (settings.modules.http) {
    ...
    requestListener = async function(request, response) {
      var archive_args, archive_name, archive_process, check, death_room_found, duellog, err, error, filename, getpath, key, len5, len6, p, parseQueryString, pass_validated, q, ref4, ref5, replay, ret_keys, roomsjson, tasks, u;
  ...
  for (p = 0, len5 = plugin_list.length; p < len5; p++) {
    plugin_filename = plugin_list[p];
