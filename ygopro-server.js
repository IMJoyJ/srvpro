...
(function() {
  ...
  if (settings.modules.cloud_replay.enabled) {
    ...
    if (settings.modules.cloud_replay.engine === 'redis') {
      ...
      for (i = m = 0, ref2 = dc_decks_index_max; 0 <= ref2 ? m < ref2 : m > ref2; i = 0 <= ref2 ? ++m : --m) {
  ...
  ban_user = global.ban_user = function(name) {
    var bad_ip, len3, len4, o, p, player, ref4, room;
    settings.ban.banned_user.push(name);
    setting_save(settings);
    bad_ip = 0;
    for (o = 0, len3 = ROOM_all.length; o < len3; o++) {
      room = ROOM_all[o];
  ...
  CLIENT_import_data = global.CLIENT_import_data = function(client, old_client, room) {
    var index, key, len3, len4, o, p, player, ref4;
    ref4 = room.players;
    for (index = o = 0, len3 = ref4.length; o < len3; index = ++o) {
      player = ref4[index];
    ...
    for (p = 0, len4 = import_datas.length; p < len4; p++) {
      key = import_datas[p];
  ...
  CLIENT_is_player = global.CLIENT_is_player = function(client, room) {
    var is_player, len3, o, player, ref4;
    is_player = false;
    ref4 = room.players;
    for (o = 0, len3 = ref4.length; o < len3; o++) {
      player = ref4[o];
  ...
  CLIENT_get_kick_reconnect_target = global.CLIENT_get_kick_reconnect_target = function(client, deckbuf) {
    var len3, len4, o, p, player, ref4, room;
    for (o = 0, len3 = ROOM_all.length; o < len3; o++) {
      room = ROOM_all[o];
  ...
  CLIENT_send_pre_reconnect_info = global.CLIENT_send_pre_reconnect_info = function(client, room, old_client) {
    var len3, o, player, ref4, req_pos;
  ...
  SOCKET_flush_data = global.SOCKET_flush_data = function(sk, datas) {
    ...
    for (o = 0, len3 = datas.length; o < len3; o++) {
      buffer = datas[o];
      sk.write(buffer);
    }
  ...
  Room = (function() {
    ...
    Room.prototype["delete"] = function() {
      var end_time, formatted_replays, index, len3, log_rep_id, name, o, player_ips, player_names, recorder_buffer, ref4, ref5, repbuf, replay_id, room_name, score, score_array, score_form;
      if (this.deleted) {
        return;
      }
      score_array = [];
    ...
    Room.prototype.send_replays = function() {
      var len3, len4, o, p, player, ref4, ref5;
    ...
    Room.prototype.disconnect = function(client, error) {
      var index, left_name, len3, len4, o, p, player, ref4, ref5;
      if (client.had_new_reconnection) {
        return;
      }
  ...
  net.createServer(function(client) {
    ...
    client.on('data', function(ctos_buffer) {
      var b, bad_ip_count, buffer, cancel, ctos_event, ctos_message_length, ctos_proto, datas, info, len3, len4, len5, len6, looplimit, o, p, q, r, ref4, ref5, room, struct;
      if (client.is_post_watcher) {
        room = ROOM_all[client.rid];
        ...
        if (client.established) {
          for (q = 0, len5 = datas.length; q < len5; q++) {
            buffer = datas[q];
            client.server.write(buffer);
          }
        } else {
          for (r = 0, len6 = datas.length; r < len6; r++) {
            buffer = datas[r];
    ...
    server.on('data', function(stoc_buffer) {
      var b, buffer, cancel, datas, info, len3, len4, len5, looplimit, o, p, q, ref4, ref5, stoc_event, stoc_message_length, stoc_proto, struct;
  ...
  ygopro.ctos_follow('JOIN_GAME', false, function(buffer, info, client, server, datas) {
    var buffer_handle_callback, check_buffer_indentity, len3, len4, len5, len6, line, match_permit_callback, name, o, p, pre_room, q, r, ref4, ref5, ref6, ref7, replay_id, room;
    ...
    if (CLIENT_is_able_to_reconnect(client) || CLIENT_is_able_to_kick_reconnect(client)) {
      ...
      if (settings.modules.cloud_replay.engine === 'mysql') {
        ...
        mysqldb.query(sql, function(err, replay) {
          ...
          results = [];
          for (i = o = 0, ref4 = replay.length; 0 <= ref4 ? o < ref4 : o > ref4; i = 0 <= ref4 ? ++o : --o) {
      ...
      buffer_handle_callback = function(buffer, decrypted_buffer, match_permit) {
        var action, len3, len4, len5, len6, line, name, o, opt1, opt2, opt3, options, p, player, q, r, ref4, ref5, ref6, ref7, room, room_title, title;
        if (client.closed) {
          return;
        }
      ...
      match_permit_callback = function(buffer, match_permit) {
        var decrypted_buffer, id, len3, o, ref4, secret;
        if (client.closed) {
          return;
        }
        ...
        challonge.participants._index({
          ...
          callback: function(err, data) {
            ...
            challonge.matches._index({
              id: settings.modules.challonge.tournament_id,
              callback: function(err, data) {
                var len4, len5, len6, len7, line, match, p, player, q, r, ref5, ref6, ref7, ref8, s;
                if (client.closed) {
                  return;
                }
                if (err || !data) {
  ...
  ygopro.stoc_follow('JOIN_GAME', false, function(buffer, info, client, server, datas) {
    var len3, len4, len5, line, o, p, player, q, recorder, ref4, ref5, ref6, room, watcher;
    room = ROOM_all[client.rid];
  ...
  ygopro.stoc_follow('GAME_MSG', true, function(buffer, info, client, server, datas) {
    var act_pos, chain, check, count, cpos, deck_found, found, hint_type, i1, id, len10, len11, len3, len4, len5, len6, len7, len8, len9, limbo_found, line, loc, max_loop, msg, o, oppo_pos, p, phase, player, playertype, pos, ppos, q, r, r_player, reason, ref10, ref11, ref12, ref13, ref14, ref4, ref5, ref6, ref7, ref8, ref9, room, s, t, trigger_location, val, win_pos, x, y, z;
    room = ROOM_all[client.rid];
    if (!(room && !client.reconnecting)) {
      return;
    }
    ...
    if (settings.modules.heartbeat_detection.enabled && ygopro.constants.MSG[msg] === 'CONFIRM_CARDS') {
      ...
      deck_found = 0;
      limbo_found = 0;
      for (i = r = 3, ref9 = max_loop; r <= ref9; i = r += 7) {
    ...
    if (settings.modules.heartbeat_detection.enabled && client.pos === 0) {
      if (ygopro.constants.MSG[msg] === 'CHAINING') {
        ...
        found = false;
        for (s = 0, len6 = long_resolve_cards.length; s < len6; s++) {
      ...
      if (ygopro.constants.MSG[msg] === 'SUMMONING' || ygopro.constants.MSG[msg] === 'SPSUMMONING' || ygopro.constants.MSG[msg] === 'CHAINING') {
        ...
        if (ygopro.constants.MSG[msg] !== 'CHAINING' || (trigger_location & 0x8) && client.ready_trap) {
          if (settings.modules.vip.enabled && room.dueling_players[act_pos].vip && vip_info.players[room.dueling_players[act_pos].name].dialogues[card]) {
            ...
            for (y = 0, len9 = ref12.length; y < len9; y++) {
              line = ref12[y];
              ygopro.stoc_send_chat(client, line, ygopro.constants.COLORS.PINK);
            }
            ...
            for (z = 0, len10 = ref13.length; z < len10; z++) {
              line = ref13[z];
              ygopro.stoc_send_chat(client, line, ygopro.constants.COLORS.PINK);
            }
            ...
            for (i1 = 0, len11 = ref14.length; i1 < len11; i1++) {
              line = ref14[i1];
              ygopro.stoc_send_chat(client, line, ygopro.constants.COLORS.PINK);
            }
          }
  ...
  ygopro.stoc_follow('HS_PLAYER_CHANGE', false, function(buffer, info, client, server, datas) {
    var is_ready, len3, len4, o, p, p1, p2, player, pos, ref4, ref5, room;
    room = ROOM_all[client.rid];
  ...
  ygopro.stoc_follow('DUEL_END', false, function(buffer, info, client, server, datas) {
    var len3, len4, o, p, player, ref4, ref5, results, room;
    room = ROOM_all[client.rid];
  ...
  wait_room_start_arena = function(room) {
    var display_name, len3, o, player, ref4;
  ...
  ygopro.stoc_follow('DUEL_START', false, function(buffer, info, client, server, datas) {
    var deck_arena, deck_name, deck_text, len3, len4, o, p, player, ref4, ref5, room;
    room = ROOM_all[client.rid];
    if (!(room && !client.reconnecting)) {
      return;
    }
  ...
  ygopro.ctos_follow('CHAT', true, function(buffer, info, client, server, datas) {
    var buy_result, cancel, ccolor, cip, cmd, cmsg, cname, color, cvalue, key, msg, name, oldmsg, ref4, room, struct, sur_player, uname, windbot, word;
    room = ROOM_all[client.rid];
    if (!room) {
      return;
    }
  ...
  ygopro.ctos_follow('UPDATE_DECK', true, function(buffer, info, client, server, datas) {
    var current_deck, deck_array, deck_main, deck_side, deck_text, deckbuf, decks, found_deck, len3, len4, line, o, oppo_pos, p, room, struct, win_pos;
    ...
    buff_main = (function() {
      var o, ref4, results;
      results = [];
      for (i = o = 0, ref4 = info.mainc; 0 <= ref4 ? o < ref4 : o > ref4; i = 0 <= ref4 ? ++o : --o) {
    ...
    buff_side = (function() {
      ...
      results = [];
      for (i = o = ref4 = info.mainc, ref5 = info.mainc + info.sidec; ref4 <= ref5 ? o < ref5 : o > ref5; i = ref4 <= ref5 ? ++o : --o) {
        results.push(info.deckbuf[i]);
      }
      return results;
    })();
    ...
    if (room.random_type || room.arena) {
      ...
      for (o = 0, len3 = decks.length; o < len3; o++) {
        deck = decks[o];
      ...
      if (found_deck) {
        ...
        for (p = 0, len4 = deck_array.length; p < len4; p++) {
          line = deck_array[p];
  ...
  ygopro.stoc_follow('CHAT', true, function(buffer, info, client, server, datas) {
    var len3, o, pid, player, ref4, room, tcolor, tplayer;
    room = ROOM_all[client.rid];
    pid = info.player;
  ...
  ygopro.stoc_follow('REPLAY', true, function(buffer, info, client, server, datas) {
    var duellog, dueltime, len3, len4, o, p, player, ref4, ref5, replay_filename, room;
    room = ROOM_all[client.rid];
    if (!room) {
  ...
  if (settings.modules.mycard.enabled) {
    setInterval(function() {
      var len3, len4, o, p, player, room, time_passed, waited_time;
      for (o = 0, len3 = ROOM_all.length; o < len3; o++) {
        room = ROOM_all[o];
      ...
      if (settings.modules.arena_mode.punish_quit_before_match) {
        for (p = 0, len4 = ROOM_all.length; p < len4; p++) {
          room = ROOM_all[p];
  ...
  setInterval(function() {
    var current_time, len3, o, results, room;
    current_time = moment();
    results = [];
    for (o = 0, len3 = ROOM_all.length; o < len3; o++) {
      room = ROOM_all[o];
  ...
  if (settings.modules.http) {
    ...
    requestListener = function(request, response) {
      var archive_args, archive_name, archive_process, check, death_room_found, duellog, error, filename, getpath, key, kick_room_found, len3, len4, len5, len6, len7, len8, len9, o, p, parseQueryString, pass_validated, player, q, r, ref4, ref5, replay, ret_keys, room, roomsjson, s, t, u, x;
      ...
      if (u.pathname === '/api/getrooms') {
        ...
        if (u.query.shout) {
          ...
          for (q = 0, len5 = ROOM_all.length; q < len5; q++) {
            room = ROOM_all[q];
            if (room && room.established) {
          ...
          for (r = 0, len6 = ROOM_all.length; r < len6; r++) {
            room = ROOM_all[r];
          ...
          for (s = 0, len7 = ROOM_all.length; s < len7; s++) {
            room = ROOM_all[s];
          ...
          death_room_found = false;
          for (t = 0, len8 = ROOM_all.length; t < len8; t++) {
            room = ROOM_all[t];
          ...
          for (x = 0, len9 = ROOM_all.length; x < len9; x++) {
            room = ROOM_all[x];
            if (!(room)) {
              continue;
            }
  ...
  for (o = 0, len3 = plugin_list.length; o < len3; o++) {
